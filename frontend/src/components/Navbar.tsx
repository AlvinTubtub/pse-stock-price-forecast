...
export default function Navbar({ companies }: { companies: CompanySummary[] }) {
  ...
  return (
    <nav className="fixed top-0 w-full glass z-50 border-b border-dark-border hidden md:block">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-64 pl-9 pr-3 py-1.5 border border-dark-border rounded-full leading-5 bg-dark-bg text-slate-300 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-brand-500 focus:border-brand-500 sm:text-sm transition-colors"
